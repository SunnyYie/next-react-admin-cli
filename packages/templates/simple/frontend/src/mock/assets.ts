import { BasicStatus, PermissionType } from './type'
import useUserStore from '../store/user-setting'
...
if (import.meta.hot) {
  import.meta.hot.accept(newModule => {
    ...
    const newUserInfo = userInfo.email === DEFAULT_USER.username ? DEFAULT_USER : TEST_USER
